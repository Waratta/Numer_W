...
function SimpsonCompositeGraph() {
  ...
  const calculate = () => {
    ...
    const approx = simpsonComposite(A, B, N);
  ...
  return (
    <div>
      <h1>Simpson’s Composite Rule</h1>
...
export default SimpsonCompositeGraph;
